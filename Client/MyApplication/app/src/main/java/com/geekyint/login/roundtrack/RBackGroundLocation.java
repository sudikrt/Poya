 ...
 */
public class RBackGroundLocation extends Service implements
    ...
    public class LocalBinder extends Binder {
        public RBackGroundLocation getServerInstance() {
            return RBackGroundLocation.this;
        }
    }
    ...
    public void onCreate() {
        ...
        ComponentName receiver = new ComponentName(this, RLocationReceiver.class);
    ...
    public void onConnected(Bundle bundle) {
        ...
        Intent intent  = new Intent (this, RLocationReceiver.class);
